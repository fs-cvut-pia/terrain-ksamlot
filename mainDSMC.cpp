...
//------------------------------------------------------------------------------------------
// Constant and types defining the properties of the computational mesh of cells
//------------------------------------------------------------------------------------------
...
int     NStep                   = 10000; //100000;       // Total number of time steps
int     FirstSamplingStep       = 1000;//10000;        // Number of the first sampling step
int     SamplingPeriod          = 1;            // Period between sampling steps
int     PrintPeriod             = 500;//10000;        // Period between printing of results
